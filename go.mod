...
require (
	...
	github.com/andygrunwald/go-gerrit v1.2.0 // indirect
...
replace github.com/argoproj/argo-cd/gitops-engine v0.7.1-0.20250908182407-97ad5b59a627 => github.com/argoproj/argo-cd/gitops-engine v0.0.0-20260518094441-db493ac2cd82
